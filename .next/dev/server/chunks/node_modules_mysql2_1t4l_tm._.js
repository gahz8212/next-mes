...
const Queue = __turbopack_context__.r("[project]/node_modules/mysql2/lib/ring_queue.js [app-route] (ecmascript)");
const SqlString = __turbopack_context__.r("[project]/node_modules/sql-escaper/lib/index.js [app-route] (ecmascript)");
...
const { traceCallback, tracePromise, getServerContext, shouldTrace, queryChannel, executeChannel, connectChannel } = __turbopack_context__.r("[project]/node_modules/mysql2/lib/tracing.js [app-route] (ecmascript)");
let _connectionId = 0;
...
class BaseConnection extends EventEmitter {
    ...
    query(sql, values, cb) {
        ...
        const rawSql = this.format(cmdQuery.sql, cmdQuery.values !== undefined ? cmdQuery.values : [], cmdQuery.namedPlaceholders);
        cmdQuery.sql = rawSql;
...
const { traceCallback, getServerContext, poolConnectChannel } = __turbopack_context__.r("[project]/node_modules/mysql2/lib/tracing.js [app-route] (ecmascript)");
...
class BasePool extends EventEmitter {
   ...
   */ _createConnectionConfig() {
        ...
        return Object.create(Object.getPrototypeOf(connectionConfig), Object.getOwnPropertyDescriptors(connectionConfig));
    }
    getConnection(cb) {
...
const Packets = __turbopack_context__.r("[project]/node_modules/mysql2/lib/packets/index.js [app-route] (ecmascript)");
const ClientConstants = __turbopack_context__.r("[project]/node_modules/mysql2/lib/constants/client.js [app-route] (ecmascript)");
const MariaDBClientConstants = __turbopack_context__.r("[project]/node_modules/mysql2/lib/constants/mariadb_client.js [app-route] (ecmascript)");
const CharsetToEncoding = __turbopack_context__.r("[project]/node_modules/mysql2/lib/constants/charset_encodings.js [app-route] (ecmascript)");
const auth41 = __turbopack_context__.r("[project]/node_modules/mysql2/lib/auth_41.js [app-route] (ecmascript)");
const { getAuthPlugin } = __turbopack_context__.r("[project]/node_modules/mysql2/lib/commands/auth_switch.js [app-route] (ecmascript)");
const { calculateToken: calculateSha2Token } = __turbopack_context__.r("[project]/node_modules/mysql2/lib/auth_plugins/caching_sha2_password.js [app-route] (ecmascript)");
...
class ClientHandshake extends Command {
    ...
    sendSSLRequest(connection) {
        const sslRequest = new Packets.SSLRequest(this.clientFlags, connection.config.charsetNumber, this.mariadbExtendedClientFlags);
    ...
    handshakeInit(helloPacket, connection) {
        ...
        connection._mariadbExtendedMetadata = Boolean(this.mariadbExtendedClientFlags & MariaDBClientConstants.MARIADB_CLIENT_EXTENDED_METADATA);
...
class Execute extends Command {
    ...
    start(packet, connection) {
        ...
        const executePacket = new Packets.Execute(this.statement.id, this.parameters, connection.config.charsetNumber, connection.config.timezone, this._executeOptions.attributes, clientFlags, connection._isMariaDB);
    ...
    readField(packet, connection) {
        ...
        const field = new Packets.ColumnDefinition(packet, connection.clientEncoding, connection._mariadbExtendedMetadata);
...
const ResetConnection = __turbopack_context__.r("[project]/node_modules/mysql2/lib/commands/reset_connection.js [app-route] (ecmascript)");
...
class Prepare extends Command {
    ...
    readParameter(packet, connection) {
        ...
        const def = new Packets.ColumnDefinition(packet, connection.clientEncoding, connection._mariadbExtendedMetadata);
...
class Query extends Command {
    constructor(options, callback){
        ...
        this.namedPlaceholders = Object.prototype.hasOwnProperty.call(options, 'namedPlaceholders') ? options.namedPlaceholders : undefined;
        this.onResult = callback;
        this.timeout = options.timeout;
        this.queryTimeout = null;
        this._fieldCount = 0;
...
"[project]/node_modules/mysql2/lib/commands/reset_connection.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function handleCompressedPacket(packet) {
    ...
    if (deflatedLength !== 0) {
        connection.inflateQueue.push((task)=>{
            zlib.inflate(body, {
                maxOutputLength: deflatedLength
            }, (err, data)=>{
                if (err) {
...
const { version } = __turbopack_context__.r("[project]/node_modules/mysql2/package.json.[json].cjs [app-route] (ecmascript)");
...
"[project]/node_modules/mysql2/lib/constants/mariadb_client.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
class ColumnDefinition {
    ...
    _parseMariadbExtendedMetadata(packet) {
        ...
        const extendedMetadataEnd = Math.min(packet.offset + extendedMetadataLength, packet.end);
...
"[project]/node_modules/mysql2/lib/packets/encode_parameter.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const Packet = __turbopack_context__.r("[project]/node_modules/mysql2/lib/packets/packet.js [app-route] (ecmascript)");
const CharsetToEncoding = __turbopack_context__.r("[project]/node_modules/mysql2/lib/constants/charset_encodings.js [app-route] (ecmascript)");
const { toParameter } = __turbopack_context__.r("[project]/node_modules/mysql2/lib/packets/encode_parameter.js [app-route] (ecmascript)");
class Execute {
    constructor(id, parameters, charsetNumber, timezone, attributes, clientFlags, jsonAsString){
        this.id = id;
        this.parameters = parameters;
    ...
    static fromPacket(packet, encoding) {
        ...
        for(let i = packet.offset + 1; i < packet.end - 1; i++){
            if ((packet.buffer[i] === Types.VAR_STRING || packet.buffer[i] === Types.BLOB || packet.buffer[i] === Types.NULL || packet.buffer[i] === Types.DOUBLE || packet.buffer[i] === Types.TINY || packet.buffer[i] === Types.DATETIME || packet.buffer[i] === Types.JSON) && packet.buffer[i + 1] === 0) {
    ...
    _serializeToBuffer(buffer) {
        ...
        if (totalParams > 0) {
            const bindParams = numParams > 0 ? this.parameters.map((v)=>toParameter(v, this.encoding, this.timezone, this.jsonAsString)) : [];
...
const ResetConnection = __turbopack_context__.r("[project]/node_modules/mysql2/lib/packets/reset_connection.js [app-route] (ecmascript)");
...
function jsonBigNumberReviver(key, value, context) {
    if (typeof value === 'number' && !Number.isSafeInteger(value) && context !== undefined && jsonIntegerSource.test(context.source)) {
...
"[project]/node_modules/mysql2/lib/packets/reset_connection.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function compile(fields, options, config) {
    ...
    /** A NULL value carries no bytes in the binary row packet, so the accessors return null without reading from it. */ function wrapNull(field) {
        return {
            ...fieldMetadata(field),
            string: function() {
                return null;
    ...
    for(let i = 0; i < fields.length; i++){
        ...
        if (typeof options.typeCast === 'function') {
            ...
            parserFn(`${lvalue} = options.typeCast(${nullWrapperVar}, function() { return null; });`);
        } else {
...
function getBinaryParser(fields, _options, config) {
    function readCode(field, config, options, fieldNum, packet) {
        ...
        // the extended metadata (MARIADB_CLIENT_EXTENDED_METADATA capability)
        if (field.extendedFormat === 'json') {
            return config.jsonStrings ? packet.readLengthCodedString(field.encoding) : packet.parseJson(field.encoding, supportBigNumbers);
        }
        switch(field.columnType){
            case Types.TINY:
                return unsigned ? packet.readInt8() : packet.readSInt8();
...
function readField({ packet, field, type, charset, encoding, config, options }) {
    const supportBigNumbers = Boolean(options.supportBigNumbers || config.supportBigNumbers);
    const bigNumberStrings = Boolean(options.bigNumberStrings || config.bigNumberStrings);
    const timezone = options.timezone || config.timezone;
    const dateStrings = options.dateStrings || config.dateStrings;
...
"[project]/node_modules/mysql2/lib/promise/capture_local_err.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const { captureStackHolder, applyCapturedStack } = __turbopack_context__.r("[project]/node_modules/mysql2/lib/promise/capture_local_err.js [app-route] (ecmascript)");
...
const { applyCapturedStack } = __turbopack_context__.r("[project]/node_modules/mysql2/lib/promise/capture_local_err.js [app-route] (ecmascript)");
...
const { captureStackHolder } = __turbopack_context__.r("[project]/node_modules/mysql2/lib/promise/capture_local_err.js [app-route] (ecmascript)");
const PromisePoolConnection = __turbopack_context__.r("[project]/node_modules/mysql2/lib/promise/pool_connection.js [app-route] (ecmascript)");
const makeDoneCb = __turbopack_context__.r("[project]/node_modules/mysql2/lib/promise/make_done_cb.js [app-route] (ecmascript)");
...
"[project]/node_modules/mysql2/lib/ring_queue.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/mysql2/lib/tracing.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/mysql2/package.json.[json].cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
//# sourceMappingURL=node_modules_mysql2_1t4l_tm._.js.map